...
real gzip/tar archive of AVRO alert packets, without extracting or parsing
their content. This is a Phase 0/1 verification step only, not the Gate Z3
ingest tool itself; no AVRO-parsing dependency has been added for it.
...
def run_probe(filename: str, out_dir: Path) -> dict:
    ...
    summary dict; does not extract or parse member content."""
...
def main() -> None:
    ...
    result = run_probe(args.filename, args.out_dir)
    print()
