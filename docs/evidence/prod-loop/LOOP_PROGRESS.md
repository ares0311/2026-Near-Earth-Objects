...
| 36 | 2026-07-02 | v0.90.12 major pivot: `docs/neo_discovery_agent_brief.md` superseded the WISE/DECam/TESS-primary plan. ZTF DR24 archival historical replay became the primary discovery path; WISE/DECam/TESS moved to secondary/paused evidence. | Run Phase 0 source verification before any ZTF DR24 ingestion code |
