...
| HB-01 | IN PROGRESS | `configs/harness/requirements.json`; `docs/harness/HARNESS_STATUS.md`; `docs/harness/HARNESS_SPECIFICATION.md` | accepted v3 registers under `docs/harness/reference/accepted-specification-v3/` |
