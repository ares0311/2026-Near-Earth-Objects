...
| HB-01 | IN PROGRESS; AUTHOR RECONSTRUCTION REQUIRED | `configs/harness/requirements.json`; `configs/harness/traceability.json`; `docs/harness/REQUIREMENT_TRACEABILITY.md`; `docs/harness/HARNESS_STATUS.md`; `docs/harness/HARNESS_SPECIFICATION.md` | current HB-01 content is an orchestrator draft and not review-eligible; separate author required |
