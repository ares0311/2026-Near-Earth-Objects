...
**Updated**: 2026-07-29 — closed HP-22 after the skip-only hosted
integration workflow was reduced to one bounded policy-notice step and passed
on merged `main` in three seconds.
