...
target concurrency and serialized deterministic persistence; add independent
negative controls; run exact new/follow-up live workflows; then run canonical
