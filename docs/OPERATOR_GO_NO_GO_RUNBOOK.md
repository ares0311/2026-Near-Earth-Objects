...
## Hunter PROD closure remediation (reopened 2026-07-27 for HP-13)
...
Closure evidence (HP-13 remains pending final verification):
...
coverage) and all 53 adversarial negative controls. The final documentation
and HP-13 commit must repeat both workflows and the freshness check before
merge.
