...
![Version](https://img.shields.io/badge/version-0.90.62-informational)
...
v0.90.62, ZTF DR24 Gates Z1, Z2, Z4, Z5, Z6, and Z7 are closed with real
...
```
┌─────────────────────────────────────────────────────────────────────┐
│                    NEO DETECTION PIPELINE  v0.90.62                  │
└─────────────────────────────────────────────────────────────────────┘
...
│   ├── __init__.py               # Package version (0.90.62)
...
### 15.1 Current State Snapshot (v0.90.62)
...
| **P46** | In progress | Frozen CNN benchmark and grouped split checks | Existing CNN wrapped as `benchmark_cnn_v1`; remaining work is defining and enforcing NEO grouped splits by night, sky region, survey/instrument, and object ID. |
...
- **CNN is not production-promoted yet**: The existing Tier 2 CNN is trained and frozen as `benchmark_cnn_v1`, but the new Astrometrics policy treats it as a benchmark until grouped splits, leakage checks, canonical evals, injection-recovery curves, and a promotion report close.
