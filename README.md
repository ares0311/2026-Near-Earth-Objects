...
![Version](https://img.shields.io/badge/version-0.58.0-informational)
![License](https://img.shields.io/badge/license-Apache%202.0-green)
![Tests](https://img.shields.io/badge/tests-2116%20passing-brightgreen)
...
```
┌─────────────────────────────────────────────────────────────────────┐
│                    NEO DETECTION PIPELINE  v0.58.0                  │
└─────────────────────────────────────────────────────────────────────┘
...
│   ├── __init__.py               # Package version (0.58.0)
...
│
├── tests/                        # pytest suite (2116 tests; 100% coverage)
...
| 8. Full test suite passes | `pytest` | 2116 / 2116 tests pass |
...
# Expected: 2116 passed in ~N seconds
```
...
| Metric | Definition | v0.58.0 Baseline |
|---|---|---|
...
### 12.4 Module Coverage Summary (v0.58.0)
