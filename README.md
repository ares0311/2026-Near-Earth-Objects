...
![Version](https://img.shields.io/badge/version-0.90.64-informational)
...
v0.90.64, ZTF DR24 Gates Z1, Z2, Z4, Z5, Z6, and Z7 are closed with real
...
```
┌─────────────────────────────────────────────────────────────────────┐
│                    NEO DETECTION PIPELINE  v0.90.64                  │
└─────────────────────────────────────────────────────────────────────┘
...
│   ├── __init__.py               # Package version (0.90.64)
...
### 15.1 Current State Snapshot (v0.90.64)
...
| **P47** | In progress | Canonical evals and injection-recovery curves | Canonical eval runner landed; convert legacy scalar validation into frozen policy-grade sample-level evals and parameterized moving-source recovery curves. |
